...
public class GuiQuarry extends GuiBase<BuiltScreenHandler> {
	...
	public void init() {
		super.init();
		mineAllButton = addButton(new GuiButtonExtended(x + 111, y + 39, 54, 20, new TranslatableText("gui.quarrymod.quarry.mine_all"), (ButtonWidget buttonWidget) -> changeMineAll(false)));
		mineOresButton = addButton(new GuiButtonExtended(x + 111, y + 39, 54, 20, new TranslatableText("gui.quarrymod.quarry.mine_ores"), (ButtonWidget buttonWidget) -> changeMineAll(true)));
